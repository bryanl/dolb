...
func (_m *FloatingIPsService) List(_a0 *godo.ListOptions) ([]godo.FloatingIP, *godo.Response, error) {
	ret := _m.Called(_a0)
...
func (_m *FloatingIPsService) Get(_a0 string) (*godo.FloatingIP, *godo.Response, error) {
	ret := _m.Called(_a0)
...
func (_m *FloatingIPsService) Create(_a0 *godo.FloatingIPCreateRequest) (*godo.FloatingIP, *godo.Response, error) {
	ret := _m.Called(_a0)
...
func (_m *FloatingIPsService) Delete(_a0 string) (*godo.Response, error) {
	ret := _m.Called(_a0)
