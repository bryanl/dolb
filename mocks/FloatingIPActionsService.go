...
func (_m *FloatingIPActionsService) Assign(ip string, dropletID int) (*godo.Action, *godo.Response, error) {
...
func (_m *FloatingIPActionsService) Unassign(ip string) (*godo.Action, *godo.Response, error) {
	ret := _m.Called(ip)
...
func (_m *FloatingIPActionsService) Get(ip string, actionID int) (*godo.Action, *godo.Response, error) {
...
func (_m *FloatingIPActionsService) List(ip string, opt *godo.ListOptions) ([]godo.Action, *godo.Response, error) {
