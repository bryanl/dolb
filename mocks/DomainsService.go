...
func (_m *DomainsService) List(_a0 *godo.ListOptions) ([]godo.Domain, *godo.Response, error) {
	ret := _m.Called(_a0)
...
func (_m *DomainsService) Get(_a0 string) (*godo.Domain, *godo.Response, error) {
	ret := _m.Called(_a0)
...
func (_m *DomainsService) Create(_a0 *godo.DomainCreateRequest) (*godo.Domain, *godo.Response, error) {
	ret := _m.Called(_a0)
...
func (_m *DomainsService) Delete(_a0 string) (*godo.Response, error) {
	ret := _m.Called(_a0)
...
func (_m *DomainsService) Records(_a0 string, _a1 *godo.ListOptions) ([]godo.DomainRecord, *godo.Response, error) {
...
func (_m *DomainsService) Record(_a0 string, _a1 int) (*godo.DomainRecord, *godo.Response, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *DomainsService) DeleteRecord(_a0 string, _a1 int) (*godo.Response, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *DomainsService) EditRecord(_a0 string, _a1 int, _a2 *godo.DomainRecordEditRequest) (*godo.DomainRecord, *godo.Response, error) {
...
func (_m *DomainsService) CreateRecord(_a0 string, _a1 *godo.DomainRecordEditRequest) (*godo.DomainRecord, *godo.Response, error) {
	ret := _m.Called(_a0, _a1)
